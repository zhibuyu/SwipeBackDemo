...
public class SwipeBackLayout extends ViewGroup {
    ...
    private FinishCallBackLister finishCallBackLister;

    public void setOnFinishCallBackLister(FinishCallBackLister listener) {
        finishCallBackLister = listener;
    }
    ...
    public void finish() {
        if(finishCallBackLister!=null){
            finishCallBackLister.HadBack();
        }
...
//        act.overridePendingTransition(0, android.R.anim.fade_out);
    ...
    public interface FinishCallBackLister{
        void HadBack();
    }
